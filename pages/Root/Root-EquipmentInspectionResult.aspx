<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Root-EquipmentInspectionResult.aspx.cs" Inherits="roles_Root_Root_EquipmentInspectionResult" %>
...
<div class="wrapper">
      ...
      <ul id="menu" class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Root-EquipmentInspectionResult.aspx"><i class="fa fa-circle-o"></i> 设备检查结果</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper" style="min-height: 916px;" >
    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">设备检查结果</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
...
<!-- Main JavaScript -->
<script type="text/javascript" src="../../js/Root/EquipmentResultJS.js"></script>
</body>
</html>
