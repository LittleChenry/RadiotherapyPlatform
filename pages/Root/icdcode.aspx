<%@ Page Language="C#" AutoEventWireup="true" CodeFile="icdcode.aspx.cs" Inherits="pages_Root_icdcode" %>
...
<div class="wrapper">
      ...
      <ul id="menu" class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="icdcode.aspx"><i class="fa fa-circle-o"></i> 病情诊断结果管理</a></li>
          </ul>
        </li>
        <li>
  ...
  <div class="content-wrapper" style="min-height: 916px;" >
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <h1 class="page-header">病情诊断结果管理</h1>
            </div>
        </div>
