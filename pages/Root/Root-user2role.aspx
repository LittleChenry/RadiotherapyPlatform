      ...
      <ul id="menu" class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="Root-user2role.aspx"><i class="fa fa-circle-o"></i>用户绑定</a></li>
          </ul>
        </li>
                    ...
                    <div class="col-xs-6">
                        <div id="changeBind" class="panel panel-default tohidden">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-sm-4">
                                    <ul class="list-unstyled" id="roles2">
...
<!-- Main JavaScript -->
<script src="../../js/Root/user2role.js" type="text/javascript"></script>
</body>
</html>
