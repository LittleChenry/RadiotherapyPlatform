  ...
  <div class="content-wrapper" style="min-height: 916px;" >
    ...
    <section class="content">
        ...
        <div class="row" style="margin-top:10px;">
            <div class="col-xs-12">
                <form id="frm" runat="server">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                    <asp:GridView ID="functionGridView" AutoGenerateColumns="False" AllowPaging="True" PageSize="8" CssClass="table table-striped table-bordered table-hover" runat="server" DataSourceID="functionObjectDataSource">
            ...
            <%--<input id="showAdd" type="button" value="新增功能" class="btn btn-outline btn-primary" data-toggle="modal" data-target="#addFunction" style="margin:15px;float:right;" />
            <div class="modal fade" id="addFunction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-top:100px;">
                <form id="addFunctionFrm" method="post" action="">
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>功能名称</td>
                                            <td>
                                                <input id="functionName" name="functionName" type="text" class="form-control controlHeight IsEmpty" placeholder="请输入功能名称" />
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
