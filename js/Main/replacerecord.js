...
function Init(evt) {
    ...
    if (patient.Progress >= 15) {
        ...
        document.getElementById("OriginCenter1").value = info.OriginCenter.split(",")[0];
        document.getElementById("OriginCenter1").disabled = "true";
        document.getElementById("OriginCenter2").value = info.OriginCenter.split(",")[1];
        document.getElementById("OriginCenter2").disabled = "true";
        document.getElementById("OriginCenter3").value = info.OriginCenter.split(",")[2];
        document.getElementById("OriginCenter3").disabled = "true";
        document.getElementById("PlanCenter1").value = info.PlanCenter.split(",")[0];
        document.getElementById("PlanCenter1").disabled = "true";
        document.getElementById("PlanCenter2").value = info.PlanCenter.split(",")[1];
        document.getElementById("PlanCenter2").disabled = "true";
        document.getElementById("PlanCenter3").value = info.PlanCenter.split(",")[2];
        document.getElementById("PlanCenter3").disabled = "true";
        document.getElementById("Movement1").value = info.Movement.split(",")[0];
        document.getElementById("Movement1").disabled = "true";
        document.getElementById("Movement2").value = info.Movement.split(",")[1];
        document.getElementById("Movement2").disabled = "true";
        document.getElementById("Movement3").value = info.Movement.split(",")[2];
        document.getElementById("Movement3").disabled = "true";
        document.getElementById("Result1").value = info.Result.split(",")[0];
        document.getElementById("Result1").disabled = "true";
        document.getElementById("Result2").value = info.Result.split(",")[1];
        document.getElementById("Result2").disabled = "true";
        document.getElementById("Result3").value = info.Result.split(",")[2];
