...
function changetoButton() {
    var select = document.getElementsByTagName("A");
    for (var i = 0; i < select.length; i++) {
        if (select[i].innerHTML == "更新" || select[i].innerHTML == "取消" || select[i].innerHTML == "编辑" || select[i].innerHTML == "激活" || select[i].innerHTML == "反激活" || select[i].innerHTML == "删除") {
            select[i].className = "btn btn-primary btn-sm";
        }
        if (select[i].innerHTML == "首页" || select[i].innerHTML == "上一页" || select[i].innerHTML == "下一页" || select[i].innerHTML == "末页") {
            select[i].className = "btn btn-primary btn-sm";
...
function addAaction() {
    ...
    for (var i = 0; i < select.length; i++) {
        if (select[i].innerHTML == "更新" || select[i].innerHTML == "取消" || select[i].innerHTML == "编辑" || select[i].innerHTML == "激活" || select[i].innerHTML == "反激活" || select[i].innerHTML == "删除") {
            select[i].addEventListener("click", changetoButton, false);
        }
    }
}
